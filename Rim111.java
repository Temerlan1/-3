...
public class Rim111 {
    ...
    void rimCalculated() {
        if (s2.equals("+")) {
            ...
            int result = rim() - rim2();
            if (result == 0) {
                System.out.println("По условиям ТЗ результат для римского выражение не может быть меньше единицы!");
            } else if (result == 1) {
                System.out.println("I");
            } else if (result == 2) {
                System.out.println("II");
    ...
    public static void main(String[] args) {
        ...
        if (r.strings.length == 3) {
            ...
            System.out.println("Введите выражение состоящее из не более чем 2 операнд");
        }
    }
}